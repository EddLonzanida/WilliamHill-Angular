...
function CreateAngular($path, $angularAppName) {
    ...
    npm i typescript@3.5.1 ts-helpers@1.1.2 eslint@6.7.2 --save-dev
  
    # app is the root folder
    ng g m shared/AppShared --module=app --flat=true
    ng g component shared/Statistics --skipTests --module=shared/app-shared
    ...
    ng g component modules/dashboard/DashboardHome --skipTests --module=modules/dashboard
...
$appName = 'WilliamHill' #GetAppName
